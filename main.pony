...
//  let door: structural._Door = structural._Door(structural.HouseDoorKey)
    ...
    functional.MonadsDesign(env)
    functional.LensDesign(env)
    functional.CakeDesign(env)
    functional.PimpDesign(env)
    //functional.StackableDesign(env)
    functional.TypeClassDesign(env)
    functional.LazyDesign(env)
    functional.PartiallyDesign(env)
    functional.ImplicitDesign(env)
    functional.DuckTypingDesign(env)
    functional.MemoizationDesign(env)